...
var fonts = [
	preload("res://Stylization/Fonts/FFSpokenTrial-Regular.ttf"),
	preload("res://Stylization/Fonts/HappyDay-Regular.ttf"),
	preload("res://Stylization/Fonts/Pencilant Script.ttf")
]
...
func _on_item_selected(index: int):
	...
	var changeTheme : Theme = load("res://Stylization/Style.theme")
